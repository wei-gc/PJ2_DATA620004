...
from tools.scripts import train_classification, test_classification, AUG
...
def main():
    wandb.init(project="classification_CIFAR")
    ...
    checkpoint_dir = os.path.join(args.work_dir, 'checkpoints', AUG)
