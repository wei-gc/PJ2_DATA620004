...
if __name__=="__main__":
    ...
    model_path = "/mnt/workspace/weigengchen/projects/FCOS/FCOS-PyTorch-37.2AP/checkpoint/model_30.pth"
    ...
    for name in names:
        ...
        plt.savefig('assets/{}'.format(name), bbox_inches='tight', pad_inches=0.0)
        plt.close()
