...
if __name__=="__main__":
    ...
    eval_dataset = VOCDataset(root_dir='/mnt/data/ai4phys/weigengchen/datasets/VOC2012/VOC2012/VOCdevkit/VOC2012', resize_size=[800, 1333],
    ...
    state_dict_path = f"./checkpoint_4gpu_train/model_{args.epoch}.pth"
    ...
    print("mAP=====>%.3f\n"%mAP)
    np.savetxt(f"eval_mAP/{args.epoch}.txt", np.array([mAP, loss]))
