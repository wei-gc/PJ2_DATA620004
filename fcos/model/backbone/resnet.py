...
def resnet50(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        model.load_state_dict(model_zoo.load_url(model_urls['resnet50'], model_dir="/mnt/workspace/weigengchen/projects/FCOS/FCOS-PyTorch-37.2AP/model/backbone"), strict=False)
    return model
